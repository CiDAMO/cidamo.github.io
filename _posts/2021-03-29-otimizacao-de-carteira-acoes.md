...
<figure class="image">
  <img src="../img/otimizacao-de-carteiras-acoes/VaR_e_CVaR_grafico.jpg" alt="igura 1. Representação gráfica das medidas VaR, CVaR e Perda Esperada. Fonte: Yamai; Yoshiba [11]." width="500" />
  <figcaption>Figura 1. Representação gráfica das medidas VaR, CVaR e Perda Esperada. Fonte: Yamai; Yoshiba [11]. </figcaption>
</figure>
...
## **Conclusão**
Com os resultados verificamos que o modelo se Fracionário Linear (FL) nem sempre apresenta resultado melhor que aos modelos Markowitz [7] e o CVaR [6], com LSR ou LIRE, pois isso depende da fração de modelo explicado $\lambda$ e dos dados das bolsas de valores. Desta forma, como verificamos pelos resultados o modelo Fracionário ora apresenta resultado melhor ora pior ou semelhante aos obtidos com os modelos MLSR e CVaR com LSR. Também averiguamos que sem usar a restrição de limite superior de risco ou usando a fração de retorno $\lambda$ menor que o obtido no modelo FL, que o modelo FL se apresenta melhor em todos os casos, que é esperado porque o modelo FL considera o retorno. 
...
## **Referências**
[1] Artzner, P., Delbaen, F., Eber, J. & Heath, D. (1999). "Coherent Measures of Risk". Mathematical Finance. 9 (3): 203–228. [https://doi.org/doi:10.1111/1467-9965.00068](https://doi.org/doi:10.1111/1467-9965.00068).

[2] Bezanson, J. & Edelman, A. & Karpinski, S. & Shah, V. B. (2017). Julia: A fresh approach to numerical computing. SIAM. [http://https://doi.org/10.1137/141000671](http://https://doi.org/10.1137/141000671).

<!-- https://www.researchgate.net/publication/349772583_Portfolio_optimization_via_a_returns_over_risk_ratio -->
[3] Brar, J., Braun, J., Hare, W., & Wang, D. (2020). Portfolio optimization via a returns over risk ratio. [https://doi.org/10.13140/RG.2.2.16187.54563](https://doi.org/10.13140/RG.2.2.16187.54563).

[4] Charnes, A. & Cooper,  W. W. (1962). Programming with linear fractional functionals. Naval Research logistics quarterly, 9, 181-186. [https://doi.org/10.1002/nav.3800090303](https://doi.org/10.1002/nav.3800090303).

[5] Maffra, S. (2013). Risco e Seleção de Portfólios com a Medida CVaR e o Modelo GO-GARCH. Disponível em [https://impa.br/wp-content/uploads/2017/08/projetos_fim_curso_sergio_maffra.pdf](https://impa.br/wp-content/uploads/2017/08/projetos_fim_curso_sergio_maffra.pdf).

[6] Markowitz, H. (1952). Portfolio selection. The journal of finance, Wiley Online Library, v. 7, n. 1, p. 77–91. [https://doi.org/10.1111/j.1540-6261.1952.tb01525.x](https://doi.org/10.1111/j.1540-6261.1952.tb01525.x).

[7] Reis, T. (2018). Value at Risk (VaR): uma ferramenta para gerenciar o risco em investimentos. Disponível em [https://www.sunoresearch.com.br/artigos/value-at-risk/](https://www.sunoresearch.com.br/artigos/value-at-risk/).

[8] Rossum, V. G., & Drake, F. L. (2009). Python 3 Reference Manual. Scotts Valley, CA: CreateSpace.

[9] Sehgal, R., Mehra, A. (2019). Robust reward–risk ratio portfolio optimization, International Transactions in Operational Research. [https://doi.org/10.1111/itor.12652](https://doi.org/10.1111/itor.12652).

[10] Yahoo! Finance. Disponível em https://finance.yahoo.com/. Acesso em 23 de novembro de 2020.
  
[11] Yamai, Y. & Yoshiba, T. (2002). On the validity of value-at-risk: comparative analyses with expected shortfall. Monetary and economic studies, 20(1), 57-85. Disponível em https://www.imes.boj.or.jp/research/papers/english/me20-1-3.pdf.
